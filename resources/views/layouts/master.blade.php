            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul class="navbar-nav">
                    ...
                    <!-- <li class="nav-item d-none d-sm-inline-block">
                        <a href="../../index3.html" class="nav-link">{{$nama_menu_1}}</a>
                    </li>
                    <li class="nav-item d-none d-sm-inline-block">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <!-- <li class="nav-item">
                        ...
                        <i class="fas fa-th-large"></i> Print
                        </a>
                    </li> -->
                    <li class="nav-item">
                        <!-- PRINT BUTTON -->
                    ...
                    <li class="nav-item">
                        <a class="nav-link" title="Pengaturan Akun">
                    ...
                    <li class="nav-item">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-divider"></div>
                                <a href="#" class="dropdown-item dropdown-footer logout-confirm">Logout</a>
                            </div>
                        </li>
                    </li>
                </ul>
